                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-6">
                                                                            <x-form.input :name="'media'"
                                                                                ...
                                                                                :value="$data->getMedia('media') ??
                                                                                    ''" />
                                                                        </div>
                                                                        <div class="col-6">
                                                                            <x-form.dropdown :value="$data->types
                                                                                ->pluck('id')
                                                                                ->toArray() ?? ''"
                                                                                :array="$types" :label="'choose types:'"
                                                                                :name="'types'">
                                                                            </x-form.dropdown>
                                                                        </div>
                                                                        @foreach ($translation as $lang)
                                                                            <div class="col-6">
                                                                                <x-form.input :name="'content[' .
                                                                                    ...
                                                                                    $lang->key .
                                                                                    ']'"
                                                                                    :type="'text'" :label="'Enter content title in ' .
                                                                                        $lang->name"
                                                                                    :placeholder="'Please enter content title in ' .
                                                                                        $lang->name" :value="json_decode($data->title)
                                                                                        ->{$lang->key} ?? ''" />
                                                                            </div>
                                                                        @endforeach
                                                                        @foreach ($translation as $lang)
